...
<form method="GET" action="{{ route('customers.index') }}" id="searchForm">
  ...
  @if(request('household_filter'))
    <input type="hidden" name="household_filter" value="{{ request('household_filter') }}">
  @endif
  @if(request('dietary_filter'))
    <input type="hidden" name="dietary_filter" value="{{ request('dietary_filter') }}">
  @endif
      ...
      <div id="search-filter-icon" style="cursor: pointer;" title="Meer filters">
        ...
        >
          <path
            ...
            stroke="{{ request('status_filter') || request('household_filter') || request('dietary_filter') ? '#cf30aa' : '#d6d6e6' }}"
            stroke-width="1"
...
#search-poda:hover > .search-darkBorderBg::before {
  transform: translate(-50%, -50%) rotate(262deg);
}
#search-poda:hover > .search-glow::before {
  transform: translate(-50%, -50%) rotate(240deg);
}
#search-poda:hover > .search-white::before {
  transform: translate(-50%, -50%) rotate(263deg);
}
#search-poda:hover > .search-border::before {
...
#search-poda:focus-within > .search-darkBorderBg::before {
  transform: translate(-50%, -50%) rotate(442deg);
  transition: all 4s;
}
#search-poda:focus-within > .search-glow::before {
  transform: translate(-50%, -50%) rotate(420deg);
  transition: all 4s;
}
#search-poda:focus-within > .search-white::before {
  transform: translate(-50%, -50%) rotate(443deg);
  transition: all 4s;
}
#search-poda:focus-within > .search-border::before {
